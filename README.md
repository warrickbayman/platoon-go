...
- Rewriting in Go removed the dependency on Laravel and Envoy
- There's no PHP and Composer requirement meaning Platoon could be used for any project using any technology.

## State

This is a very early-stage project. I want to rebuild all the existing features into this version, and I'm still learning alot about Go. This should not be used at all. Please wait for a proper release version.
